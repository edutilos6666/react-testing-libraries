...
// const ReactBurgerMenuExample = props=> {

// }

// export default ReactBurgerMenuExample;
...
class ReactBurgerMenuExample extends Component {
  constructor(props) {
    super(props);
    this.state = {
      currentMenu: "slide",
...
export default ReactBurgerMenuExample;
// ReactDOM.render(<ReactBurgerMenuExample menus={menus} />, document.getElementById('app'));
